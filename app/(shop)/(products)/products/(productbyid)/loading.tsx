export default function Loading() {
    return (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 bg-white dark:bg-zinc-950 h-full flex-1">
            <div className="flex flex-col md:flex-row gap-10 md:gap-16">

                {/* Image */}
                <div className="w-full md:w-1/2">
                    <div className="aspect-square w-full rounded-3xl bg-zinc-200 dark:bg-zinc-700 animate-pulse" />
                </div>
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center gap-4">
                    ...
                    {/* Name */}
                    <div className="h-10 w-3/4 bg-zinc-200 dark:bg-zinc-700 rounded-lg animate-pulse" />
                    {/* Price */}
                    <div className="h-8 w-24 bg-zinc-200 dark:bg-zinc-700 rounded-lg animate-pulse" />
                    {/* Description lines */}
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        ...
                        <div className="h-6 w-32 bg-zinc-200 dark:bg-zinc-700 rounded-full animate-pulse" />
                    </div>
                    {/* Button */}
